          ...
          <div className="main-container">
            <div className="buttons-container">
              ...
              {modifyButtonShow && 
                ...
                <button className='seat-save-and-close-button' onClick={modifyHandler}>저장</button>
